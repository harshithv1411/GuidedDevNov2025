namespace Terrasoft.Core.Process
{
	...
	#region Class: UsrCalculateAverageTicketPriceMethodsWrapper

	/// <exclude/>
	public class UsrCalculateAverageTicketPriceMethodsWrapper : ProcessModel
	{

		public UsrCalculateAverageTicketPriceMethodsWrapper(Process process)
			: base(process) {
